...
function toggleStyleSheet() {
    ...
    var cur_style = document.getElementById("page_style").getAttribute("href");

    // 1 (c) Determine new stylesheet file name
    if (cur_style === "light.css") {
        cur_style = "dark.css";
    }
    else if (cur_style === "dark.css") {
        cur_style = "light.css";
    }

    // 1 (d) replace stylesheet with new stylesheet (hint: element.setAttribute)
    // document.getElementById("MyElement").classList.toggle('MyClass');
    document.getElementById("page_style").setAttribute("href", cur_style);
...
window.onload = function(){
    ...
    document.getElementById("page_style").setAttribute("href", localStorage.getItem("prev_style"));
}
